<?php
    ...
    if (!isset($_GET["power"])) $power = 10; else {
        $power = $_GET["power"];
    ...
    // Sprawdź, czy "power" jest większe od 1000. Jeśli tak, daj błąd.
    if($power > 1000) return require "errors/453.php";
    ...
    imagefilter($image, IMG_FILTER_PIXELATE, $power);
